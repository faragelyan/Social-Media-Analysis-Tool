...
# Requirement 5.I: Filtering nodes based on centrality measures (degree, betweenness, closeness, eigenvector)
# Requirement 5.II: Filtering nodes based on centrality score ranges
class FilteringPanel(QWidget):
    def __init__(self, graph_manager, visualization_panel):
        super().__init__()
        self.graph_manager = graph_manager
